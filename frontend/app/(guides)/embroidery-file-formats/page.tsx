    ...
    <main className="min-h-screen">
      ...
      <div className="py-12 px-6">
        <div className="max-w-4xl mx-auto bg-white border-2 border-black shadow-brutal-lg p-8 md:p-12 space-y-12">
          ...
          <h2 className="text-3xl font-black text-black mb-6 mt-12 uppercase tracking-tight border-l-4 border-cyan-400 pl-4">Why Are There So Many Formats?</h2>
          <p className="text-black/80 leading-relaxed font-medium">
          ...
          <h2 className="text-3xl font-black text-black mb-6 mt-12 uppercase tracking-tight border-l-4 border-cyan-400 pl-4">The Major Embroidery File Formats</h2>

          <div className="space-y-8 mt-8">
            <div className="p-6 border-2 border-black bg-white shadow-brutal-sm hover:bg-[#f0ebe3] transition-colors">
              <h3 className="text-2xl font-black text-black mb-3 uppercase">DST - Tajima (Industry Standard)</h3>
              <p className="text-black/80 leading-relaxed font-medium">
                <strong>Who uses it:</strong> Commercial embroidery machines, professional digitizers, production facilities
              </p>
              <p className="text-black/80 leading-relaxed mt-2 font-medium">
            ...
            <div className="p-6 border-2 border-black bg-white shadow-brutal-sm hover:bg-[#f0ebe3] transition-colors">
              <h3 className="text-2xl font-black text-black mb-3 uppercase">PES - Brother</h3>
              <p className="text-black/80 leading-relaxed font-medium">
            ...
            <div className="p-6 border-2 border-black bg-white shadow-brutal-sm hover:bg-[#f0ebe3] transition-colors">
              <h3 className="text-2xl font-black text-black mb-3 uppercase">JEF - Janome</h3>
              <p className="text-black/80 leading-relaxed font-medium">
            ...
            <div className="p-6 border-2 border-black bg-white shadow-brutal-sm hover:bg-[#f0ebe3] transition-colors">
              <h3 className="text-2xl font-black text-black mb-3 uppercase">EXP - Melco</h3>
              <p className="text-black/80 leading-relaxed font-medium">
            ...
            <div className="p-6 border-2 border-black bg-white shadow-brutal-sm hover:bg-[#f0ebe3] transition-colors">
              <h3 className="text-2xl font-black text-black mb-3 uppercase">Other Formats</h3>
              <ul className="text-black/80 space-y-2 mt-3 font-medium">
          ...
          <h2 className="text-3xl font-black text-black mb-6 mt-12 uppercase tracking-tight border-l-4 border-cyan-400 pl-4">Choosing the Right Format</h2>
          <p className="text-black/80 leading-relaxed font-medium">
            The format you need depends on your embroidery machine:
          </p>
          <ul className="space-y-3 text-black/80 mt-4 font-medium">
          ...
          <h2 className="text-3xl font-black text-black mb-6 mt-12 uppercase tracking-tight border-l-4 border-cyan-400 pl-4">Common Conversion Challenges</h2>
          <p className="text-black/80 leading-relaxed font-medium">
          ...
          <h2 className="text-3xl font-black text-black mb-6 mt-12 uppercase tracking-tight border-l-4 border-cyan-400 pl-4">File Format Best Practices</h2>
          ...
          <h2 className="text-3xl font-black text-black mb-6 mt-12 uppercase tracking-tight border-l-4 border-cyan-400 pl-4">The Future of Embroidery Formats</h2>
          <p className="text-black/80 leading-relaxed font-medium">
        ...
        <div className="text-center p-8 bg-cyan-400 border-2 border-black shadow-brutal">
          <h2 className="text-2xl font-black text-black mb-4 uppercase tracking-tight">Convert Any Embroidery Format</h2>
          <p className="text-black/80 mb-6 font-medium">Support for all major formats - DST, PES, JEF, EXP, and more</p>
      ...
      <footer className="border-t-2 border-black bg-[#1a1a1a] py-8 mt-12">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <p className="text-sm text-white/80 font-medium">ThreadShifter - Free Embroidery File Converter</p>
        </div>
      </footer>
    </main>
  );
